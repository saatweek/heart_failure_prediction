---
title: "Models (with Categorical Cholesterol)"
...
# Converting Cholesterol into a categorical column
df <- df %>% 
  mutate(fCholesterol = 
           case_when(Cholesterol < 100 ~ "< 100",
                     Cholesterol  >= 100 & Cholesterol < 200 ~ "100-200",
                     Cholesterol  >= 200 & Cholesterol < 300 ~ "200-300",
                     Cholesterol  >= 300 & Cholesterol < 400 ~ "300-400",
                     Cholesterol  >= 400 & Cholesterol < 500 ~ "400-500",
                     Cholesterol  >= 500 ~ "> 500")) %>% 
  mutate(fCholesterol = factor(fCholesterol))
...
model2 <- glm(HeartDisease ~ (Sex + ChestPainType + FastingBS + 
                                ExerciseAngina + Oldpeak +ST_Slope), 
              data=train, family="binomial") # Significant from model1

model3 <- glm(HeartDisease ~ (Sex + ChestPainType + FastingBS + 
